...
;; FEITO
(define (acha33 lista6)
  (if (= (first lista6) 33) 33 ( acha33 (rest lista6))))

(define elem3-lista6 (acha33 lista6))
...
;;(define (max-lista l)
  ;;((empty? l) 0
             ;; (cond
    ;;[(if ( > (- first(l) (first (rest l))) 0) )]
    ;;[()]
   ;; )
(define (max-lista l)
  (cond
    [(empty? l) 0]
    [(<= (first l) (max-lista (rest l)) ) (max-lista (rest l))]
    [(>= (first l) (max-lista (rest l)) ) (first l)]
    )
  )
